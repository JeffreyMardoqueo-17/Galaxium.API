            ...
            var claims = new List<Claim>
{
    ...
    // Tenant isolation claim used by multi-tenant features
    ...
    // Human-readable tenant name for future UI and logs
    new Claim("tenant_name", user.Tenant?.Name ?? string.Empty),
